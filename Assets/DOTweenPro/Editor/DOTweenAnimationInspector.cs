...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        static readonly Dictionary<DOTweenAnimation.AnimationType, Type[]> _AnimationTypeToComponent = new Dictionary<DOTweenAnimation.AnimationType, Type[]>() {
            ...
            { DOTweenAnimation.AnimationType.UIAnchorPosition, new[] { typeof(RectTransform) } },
#endif
            { DOTweenAnimation.AnimationType.Jump, new[] { typeof(Transform) } },
            { DOTweenAnimation.AnimationType.LocalJump, new[] { typeof(Transform) } },
        };
...
#endif
#if true // UI_MARKER
            "UI/WidthHeight","UI/AnchorPosition",
#endif
        ...
        override public void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                if (prevAnimType != _src.animationType)
                {
                    ...
                    {
                        case DOTweenAnimation.AnimationType.Jump:
                        case DOTweenAnimation.AnimationType.LocalJump:
                        ...
                        case DOTweenAnimation.AnimationType.UIWidthHeight:
                            ...
                            break;
                        case DOTweenAnimation.AnimationType.UIAnchorPosition:
                            _src.endValueV3 = Vector3.zero;
                            _src.endValueFloat = 0;
                            _src.optionalBool0 = _src.animationType == DOTweenAnimation.AnimationType.UIAnchorPosition;
                            break;
                ...
                switch (_src.animationType)
                {
                    case DOTweenAnimation.AnimationType.Jump:
                    case DOTweenAnimation.AnimationType.LocalJump:
                        _src.optionalFloat0 = EditorGUILayout.FloatField("Power", _src.optionalFloat0);
                        _src.optionalInt0 = EditorGUILayout.IntField("Num Of Jumps", _src.optionalInt0);
