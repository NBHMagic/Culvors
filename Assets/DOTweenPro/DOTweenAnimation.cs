...
namespace DG.Tweening
{
    ...
    public class DOTweenAnimation : ABSAnimationComponent
    {
        public enum AnimationType
        {
            ...
            UIWidthHeight, UIAnchorPosition,
            Jump, LocalJump
        }
        ...
        public void CreateTween(bool regenerateIfExists = false, bool andPlay = true)
        {
            ...
            switch (animationType)
            {
                ...
                case AnimationType.Jump:
                    tween = ((Transform)target).DOJump(endValueV3, optionalFloat0, optionalInt0, duration, optionalBool0);
                    break;
                case AnimationType.LocalJump:
                    tween = ((Transform)target).DOLocalJump(endValueV3, optionalFloat0, optionalInt0, duration, optionalBool0);
                    break;
                ...
                case AnimationType.UIWidthHeight:
                    ...
                    break;
                case AnimationType.UIAnchorPosition:
                    tween = ((RectTransform)target).DOAnchorPos(optionalBool0 ? new Vector2(endValueFloat, endValueFloat) : endValueV2, duration);
                    break;
#endif
