...
public class CandyController : MonoBehaviour {
	...
	void Start() {
		...
		if(!MainGameController.Instance.canUseCandy)
	...
	void managePlayerDrag() {
		...
		if(Physics.Raycast(ray, out hitInfo)) {
			...
			if(objectHit.tag == "buyMoreCandy" && MainGameController.Instance.totalMoneyMade >= (5 * candyPrice)) {
				print("Bought 5 candy!");
				availableCandy += 5;
				MainGameController.Instance.totalMoneyMade -= 5 * candyPrice;
				playSfx(checkout);
